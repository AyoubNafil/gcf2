    ...
    <div class="page-wrapper chiller-theme toggled">
        ...
        <nav id="sidebar" class="sidebar-wrapper">
            <div class="sidebar-content">
                ...
                <div class="sidebar-header" style="background:url(user-img-background.jpg);">
                    <div class="user-pic">
...
<!--                        <li>
 ...
 <!--                        <li>
                        ...
                        <li>
                            <a href="./index.php?p=Search"><i class="zmdi zmdi-hc-1x zmdi-check"></i>List classes par filiere</a>
                        </li>
                        <li class="header-menu">
